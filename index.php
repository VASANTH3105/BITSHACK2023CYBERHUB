    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="enrollment.php" class="navbar-link" data-navbar-link>Catogory</a>
          </li>
          ...
          <li class="navbar-item">
            <a href="cart.php" class="navbar-link" data-navbar-link>My Learning path</a>
          </li>
        ...
        <div class="container">
          ...
          <div class="about-content">
            ...
            <p class="about-text">
              ...
              to advanced hacking techniques. We ensure that learners gain a holistic understanding of the
              field.
          ...
          <ul class="service-list">
            ...
            <li>
              <div class="service-card">
                ...
                <p class="text">
                Our curriculum covers a wide spectrum of cybersecurity topics, from the fundamentals of network security
                to advanced ethical hacking techniques. We ensure that learners gain understanding of the
            ...
            <li>
              <div class="service-card">
                ...
                <p class="text">
                Reinforce your learning through our quiz section. Test your knowledge, track your progress, and gain
                valuable insights into your strengths and areas for improvement in your domain. Our quizzes are designed to challenge you
                and help you grow and enhance your skills.
                </p>
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3 title">Cyber games</h3>
  ...
  <footer class="footer">
    ...
    <div class="footer-top section">
      <div class="container">
        ...
        <li>
            <a href="#" class="footer-link" data-email="cyberhuboffbit@gmail.com">cyberhuboffbit@gmail.com</a>
        </li>

        <li>
            <a href="#" class="footer-link" id="email-link" data-email="vasanth.it21@bitsathy.ac.in">vasanth.it21@bitsathy.ac.in</a>
        </li>

        <li>
            <a href="#" class="footer-link" data-email="vasanth31052004@gmail.com">vasanth31052004@gmail.com</a>
        </li>

        <li>
            <a href="#" class="footer-link" data-email="saran@gmail.com">saran@gmail.com</a>
        </li>

        <li>
            <a href="#" class="footer-link" data-email="mohan@gmail.com">mohan@gmail.com</a>
        </li>
    </ul>
  ...
  <script>
    document.querySelectorAll('.footer-link').forEach(function(link) {
            link.addEventListener('click', function (e) {
                ...
                var emailAddress = link.getAttribute('data-email');

                // Default mail subject
                var subject = 'User communication from CYBERHUB';

                // Compose the Gmail URL with subject
                var gmailURL = 'https://mail.google.com/mail/?view=cm&to=' + encodeURIComponent(emailAddress) + '&su=' + encodeURIComponent(subject);
